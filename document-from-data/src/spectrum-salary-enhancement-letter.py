...
DATA_SERIALIZERS = {
    'salary-enhancement': {
        'input-template': '../template/salary-enhancement/HR__salary-enhancement-template__2022.odt',
...
def output_data(output_processor, processed_data):
    ...
    for item in data:
        ...
        # generate the file
        fields = {"sequence": item["sequence"], "name": item["name"], "salutation": item["salutation"], "wing": item["wing"], "unit": item["unit"], "supervisor": item["supervisor"], "salary": item["salary"], "increment": item["increment"], "promotion": item["promotion"], "grade": item["grade"], "designation": item["designation"]}
