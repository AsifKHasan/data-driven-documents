...
'''
    ...
    python cybernetics-salary-advice-app.py
'''
import os
import yaml
import time
...
from cybernetics_advice_generator import AdviceGenerator
...
class SalaryAdviceApp:
    ...
    def save_selection(self, _):
        ...
        yaml.dump(self.config, open('../conf/config-cybernetics.yml', 'w', encoding='utf-8'))
    ...
    def init_generator(self):
        ...
        result = self.advice_generator.init(os.path.abspath('../conf/credential-spectrum-895-221613.json'), os.path.abspath('../template/cybernetics'), os.path.abspath('../out/cybernetics'))
...
if __name__ == '__main__':
    # configuration
    config = yaml.load(open('../conf/config-cybernetics.yml', 'r', encoding='utf-8'), Loader=yaml.FullLoader)

    root = tk.Tk()
    root.title('Cybernetics : Salary advice generator')
